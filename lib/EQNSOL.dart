...
class _EQNSOLState extends State<EQNSOL> {
  ...
  void solveeqn() {
    ...
    sol.children.add(Padding(
      child: Text(
        s,
        style: TextStyle(fontFamily: "cambria", fontSize: 20),
      ),
    ...
    for (int i = 0; i < p.length; i++) {
      ...
      if (dpabs(p[i].imaginary) != 0)
        sq += (dpabs(p[i].imaginary) > 0 ? "  +" : "  ") +
            dpabs(p[i].imaginary).toString() +
            " i";
      if (dpabs(p[i].real) == 0 && dpabs(p[i].imaginary) == 0) sq += "0";
      t.add(
        TableRow(
          children: [
            Padding(
                      ...
                      children: [
                        ...
                        Padding(
                          child: Text(
                            "Solution:",
                            style:
                                TextStyle(fontFamily: "cambria", fontSize: 25),
                          ),
                          padding: EdgeInsets.all(10),
                        ),
                        Divider(
